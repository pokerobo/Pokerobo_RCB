...
#define PROGRAM_MODE_REAL_STATION           1
#define PROGRAM_MODE_TEST_STATION           2
...
class ProgramSelector {
  public:
    int begin(uint8_t mode=PROGRAM_MODE_REAL_STATION);
    ...
    int check();
  private:
    uint8_t _mode = PROGRAM_MODE_REAL_STATION;
